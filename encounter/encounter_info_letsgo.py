...
class EncounterInfoLetsGo(EncounterInfo):
    ...
    def __init__(self, table, path: str, id: int, data: bytes) -> None:
        ...
        self.table_level_min = self._method_data["table_level_min"]
        self.table_level_max = self._method_data["table_level_max"]
    ...
    def location_area_id(self) -> int:
        oi = {
            ...
            11386706514488678199: "diglett's cave",
        ...
        if self.zone_id not in oi:
            print(self.zone_id, hex(self.zone_id))
            exit()
        return oi[self.zone_id]
